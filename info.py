...
PICS = (environ.get('PICS' ,'https://telegra.ph/file/c0257f32a476795111a74.jpg')).split()
BOT_START_TIME = time()

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1489446496').split()]
...
WELCOM_PIC = environ.get("WELCOM_PIC", "https://telegra.ph/file/c0257f32a476795111a74.jpg")
